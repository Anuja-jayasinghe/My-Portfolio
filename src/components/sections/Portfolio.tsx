...
import GitHubUplink from "../ui/GitHubUplink";
            ...
            <div className="container mx-auto px-4 sm:px-6">
                ...
                <div className="mb-20">
                    <div className="mb-6">
                        ...
                        <p className="text-gray-500 text-xs sm:text-sm font-mono max-w-xl text-balance">
                            Analyzing kernel contributions and development velocity. Real-time uplink to central repository manifest.
                        </p>
                    </div>
                    <GitHubUplink />
                </div>
...
function ActivityIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-activity text-accent">
