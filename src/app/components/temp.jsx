...
//   return (
//     <div className="fixed right-0 top-1/2 -translate-y-1/2 z-0">
...
//                 left: "50%",
//                 top: "50%",
//                 // Rotate to position, move outward, then counter-rotate to keep upright, then center
//                 transform: `
//                   translate(-50%, -50%)
//                   rotate(${link.angle}deg)
//                   translateY(-${radius}px)
//                   rotate(${-link.angle - rotation}deg)
//                 `
//               }}
//             >
